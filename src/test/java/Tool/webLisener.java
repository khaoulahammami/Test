...
public class webLisener implements WebDriverEventListener{
	...
	public void afterNavigateTo(String url, WebDriver driver) {
		System.out.println("Navigating after '" + url + "'");
	...
	public void afterClickOn(WebElement element, WebDriver driver) {
		...
		try {
			TestTOOL.tackepicture(driver, "C:\\Users\\khaou\\eclipse-workspace\\regi\\TestReport");
		} catch (IOException e) {
